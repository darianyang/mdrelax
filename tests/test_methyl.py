...
def test_ch3_rate_definitions_ordered(ff15ipq_rates):
    """R_Dy (transverse) is the largest of the four 2H rates."""
    rates_ref, _ = ff15ipq_rates
    mean_rates = rates_ref.mean(axis=(1, 2))     # R_Dz, R_Dy, R3, R4
